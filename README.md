...
-   `GLS_FORK_CLEANER_INTERVAL` - интервал запуска клинера неактуальных записей восстановления в случае форков.  
...
-   `GLS_USE_IN_MEMORY_FEED_CACHE` - нужно ли использовать кеширование лент в памяти.
