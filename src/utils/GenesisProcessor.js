...
const { env } = core.data;
const { Logger, Parallel, metrics } = core.utils;
const GenesisContentController = require('../controllers/prism/GenesisContent');
...
class GenesisProcessor {
    constructor() {
        ...
        this._genesisContentController = new GenesisContentController();
    ...
    _checkQueues() {
        ...
        const controllerQueueLength = this._genesisContentController.getQueueLength();
    ...
    async _handleEvent(type, data) {
        ...
        const isProcessed = await this._genesisContentController.handle(type, data);
    ...
    async _onTypeEnd(type) {
        ...
        await this._genesisContentController.typeEnd(type);
    }
    ...
    async _onDataEnd() {
        ...
        await this._genesisContentController.finish();
