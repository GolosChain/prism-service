...
env.GLS_EXPORT_GOLOS_USERS = env.GLS_EXPORT_GOLOS_USERS === 'true';
...
module.exports = {
    ...
    GLS_EXPORT_GOLOS_USERS: env.GLS_EXPORT_GOLOS_USERS || false,
    GLS_EXPORT_GOLOS_USERS_CONNECT: env.GLS_EXPORT_GOLOS_USERS_CONNECT,
    GLS_SEARCH_ENABLED: Boolean(env.GLS_SEARCH_ENABLED),
};
